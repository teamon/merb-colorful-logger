...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "TODO", "lib/merb-colorful-logger", "lib/merb-colorful-logger/merbtasks.rb", "lib/merb-colorful-logger.rb", "spec/merb-colorful-logger_spec.rb", "spec/spec_helper.rb"]
  s.has_rdoc = true
